...
for N = 0 : nStep2 - 1
    ...
    fileName = sprintf('calib/H_I_%02d.png', N + nStep1);
    imwrite(Ib', fileName);
...
% compute median frequency phase
...
for N = 0 : nStep3-1
    ...
    Ib = dither(uint8(I0 * 255));
    fileName = sprintf('calib/H_I_%02d.png', N + nStep1 + nStep2);
